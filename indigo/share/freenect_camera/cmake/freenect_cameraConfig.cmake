...
if("FALSE" STREQUAL "TRUE")
  set(freenect_camera_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-freenect-camera-0.4.1)
  set(freenect_camera_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-freenect-camera-0.4.1/obj-i686-linux-gnu/devel)
  ...
  set(freenect_camera_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'freenect_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Jack O'Quin <jack.oquin@gmail.com>, Piyush Khandelwal <piyushk@gmail.com>' to fix it.")
    endif()
