...
if("FALSE" STREQUAL "TRUE")
  set(turtlebot_follower_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-turtlebot-follower-2.3.3)
  set(turtlebot_follower_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-turtlebot-follower-2.3.3/obj-i686-linux-gnu/devel)
  ...
  set(turtlebot_follower_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include;/usr/include;/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include/ni;/usr/include/vtk-5.8 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_follower' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Daniel Stonier <stonier@rnd.yujinrobot.com>' to fix it.")
    endif()
