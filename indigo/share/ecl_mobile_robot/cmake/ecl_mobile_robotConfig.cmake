...
if("FALSE" STREQUAL "TRUE")
  set(ecl_mobile_robot_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-ecl-mobile-robot-0.60.1)
  set(ecl_mobile_robot_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-ecl-mobile-robot-0.60.1/obj-i686-linux-gnu/devel)
  ...
  set(ecl_mobile_robot_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ecl_mobile_robot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Daniel Stonier <d.stonier@gmail.com>' to fix it.")
    endif()
