...
if("FALSE" STREQUAL "TRUE")
  set(yocs_cmd_vel_mux_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-yocs-cmd-vel-mux-0.6.4)
  set(yocs_cmd_vel_mux_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-yocs-cmd-vel-mux-0.6.4/obj-i686-linux-gnu/devel)
  ...
  set(yocs_cmd_vel_mux_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'yocs_cmd_vel_mux' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Jihoon Lee <jihoonl@yujinrobot.com>' to fix it.")
    endif()
