...
if("FALSE" STREQUAL "TRUE")
  set(ecl_streams_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-ecl-streams-0.61.14)
  set(ecl_streams_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-ecl-streams-0.61.14/obj-i686-linux-gnu/devel)
  ...
  set(ecl_streams_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ecl_streams' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Daniel Stonier <d.stonier@gmail.com>' to fix it.")
    endif()
