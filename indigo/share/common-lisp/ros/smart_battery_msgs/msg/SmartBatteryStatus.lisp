...
(cl:in-package smart_battery_msgs-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <SmartBatteryStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SmartBatteryStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smart_battery_msgs-msg:<SmartBatteryStatus> is deprecated: use smart_battery_msgs-msg:SmartBatteryStatus instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <SmartBatteryStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smart_battery_msgs-msg:header-val is deprecated.  Use smart_battery_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'voltage-val :lambda-list '(m))
(cl:defmethod voltage-val ((m <SmartBatteryStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smart_battery_msgs-msg:voltage-val is deprecated.  Use smart_battery_msgs-msg:voltage instead.")
  (voltage m))

(cl:ensure-generic-function 'rate-val :lambda-list '(m))
(cl:defmethod rate-val ((m <SmartBatteryStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smart_battery_msgs-msg:rate-val is deprecated.  Use smart_battery_msgs-msg:rate instead.")
  (rate m))

(cl:ensure-generic-function 'charge-val :lambda-list '(m))
(cl:defmethod charge-val ((m <SmartBatteryStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smart_battery_msgs-msg:charge-val is deprecated.  Use smart_battery_msgs-msg:charge instead.")
  (charge m))

(cl:ensure-generic-function 'capacity-val :lambda-list '(m))
(cl:defmethod capacity-val ((m <SmartBatteryStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smart_battery_msgs-msg:capacity-val is deprecated.  Use smart_battery_msgs-msg:capacity instead.")
  (capacity m))

(cl:ensure-generic-function 'design_capacity-val :lambda-list '(m))
(cl:defmethod design_capacity-val ((m <SmartBatteryStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smart_battery_msgs-msg:design_capacity-val is deprecated.  Use smart_battery_msgs-msg:design_capacity instead.")
  (design_capacity m))

(cl:ensure-generic-function 'percentage-val :lambda-list '(m))
(cl:defmethod percentage-val ((m <SmartBatteryStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smart_battery_msgs-msg:percentage-val is deprecated.  Use smart_battery_msgs-msg:percentage instead.")
  (percentage m))

(cl:ensure-generic-function 'charge_state-val :lambda-list '(m))
(cl:defmethod charge_state-val ((m <SmartBatteryStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smart_battery_msgs-msg:charge_state-val is deprecated.  Use smart_battery_msgs-msg:charge_state instead.")
  (charge_state m))

(cl:ensure-generic-function 'present-val :lambda-list '(m))
(cl:defmethod present-val ((m <SmartBatteryStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smart_battery_msgs-msg:present-val is deprecated.  Use smart_battery_msgs-msg:present instead.")
  (present m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<SmartBatteryStatus>)))
    "Constants for message type '<SmartBatteryStatus>"
  '((:DISCHARGING . 0)
    (:CHARGING . 1)
    (:CHARGED . 2))
)
