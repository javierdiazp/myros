...
if("FALSE" STREQUAL "TRUE")
  set(kobuki_description_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-kobuki-description-0.6.7)
  set(kobuki_description_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-kobuki-description-0.6.7/obj-i686-linux-gnu/devel)
  ...
  set(kobuki_description_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kobuki_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Younghun Ju <yhju@yujinrobot.com>' to fix it.")
    endif()
