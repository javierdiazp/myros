...
if("FALSE" STREQUAL "TRUE")
  set(ecl_errors_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-ecl-errors-0.61.6)
  set(ecl_errors_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-ecl-errors-0.61.6/obj-i686-linux-gnu/devel)
  ...
  set(ecl_errors_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ecl_errors' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Daniel Stonier <d.stonier@gmail.com>' to fix it.")
    endif()
