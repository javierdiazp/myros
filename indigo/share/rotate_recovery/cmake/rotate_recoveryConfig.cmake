...
if("FALSE" STREQUAL "TRUE")
  set(rotate_recovery_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-rotate-recovery-1.12.13)
  set(rotate_recovery_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-rotate-recovery-1.12.13/obj-i686-linux-gnu/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotate_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
