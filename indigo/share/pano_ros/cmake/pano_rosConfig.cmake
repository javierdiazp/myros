...
if("FALSE" STREQUAL "TRUE")
  set(pano_ros_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-pano-ros-2.3.3)
  set(pano_ros_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-pano-ros-2.3.3/obj-i686-linux-gnu/devel)
  set(pano_ros_INSTALL_PREFIX "")
  set(pano_ros_PREFIX ${pano_ros_DEVEL_PREFIX})
else()
  set(pano_ros_SOURCE_PREFIX "")
  set(pano_ros_DEVEL_PREFIX "")
  set(pano_ros_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pano_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Jihoon Lee <jihoonlee.in@gmail.com>' to fix it.")
    endif()
