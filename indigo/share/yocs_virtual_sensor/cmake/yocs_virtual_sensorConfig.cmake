...
if("FALSE" STREQUAL "TRUE")
  set(yocs_virtual_sensor_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-yocs-virtual-sensor-0.6.4)
  set(yocs_virtual_sensor_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-yocs-virtual-sensor-0.6.4/obj-i686-linux-gnu/devel)
  ...
  set(yocs_virtual_sensor_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'yocs_virtual_sensor' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Jihoon Lee <jihoonl@yujinrobot.com>' to fix it.")
    endif()
    _list_append_unique(yocs_virtual_sensor_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/lib/i386-linux-gnu/libboost_system.so")
