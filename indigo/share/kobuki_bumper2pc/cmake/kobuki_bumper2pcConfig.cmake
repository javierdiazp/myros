...
if("FALSE" STREQUAL "TRUE")
  set(kobuki_bumper2pc_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-kobuki-bumper2pc-0.6.7)
  set(kobuki_bumper2pc_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-kobuki-bumper2pc-0.6.7/obj-i686-linux-gnu/devel)
  ...
  set(kobuki_bumper2pc_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kobuki_bumper2pc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Jorge Santos Simon <jorge@yujinrobot.com>' to fix it.")
    endif()
