...
if("FALSE" STREQUAL "TRUE")
  set(ecl_threads_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-ecl-threads-0.61.14)
  set(ecl_threads_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-ecl-threads-0.61.14/obj-i686-linux-gnu/devel)
  ...
  set(ecl_threads_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ecl_threads' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Daniel Stonier <d.stonier@gmail.com>' to fix it.")
    endif()
