...
if("FALSE" STREQUAL "TRUE")
  set(kobuki_capabilities_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-kobuki-capabilities-0.6.7)
  set(kobuki_capabilities_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-kobuki-capabilities-0.6.7/obj-i686-linux-gnu/devel)
  ...
  set(kobuki_capabilities_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kobuki_capabilities' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Marcus Liebhardt <marcus.liebhardt@yujinrobot.com>' to fix it.")
    endif()
