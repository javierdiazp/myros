...
if("FALSE" STREQUAL "TRUE")
  set(turtlebot_calibration_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-turtlebot-calibration-2.3.3)
  set(turtlebot_calibration_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-turtlebot-calibration-2.3.3/obj-i686-linux-gnu/devel)
  ...
  set(turtlebot_calibration_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_calibration' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'OSRF <turtlebot@osrfoundation.org>' to fix it.")
    endif()
