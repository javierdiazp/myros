...
if("FALSE" STREQUAL "TRUE")
  set(openni2_camera_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-openni2-camera-0.2.7)
  set(openni2_camera_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-openni2-camera-0.2.7/obj-i686-linux-gnu/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openni2_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
