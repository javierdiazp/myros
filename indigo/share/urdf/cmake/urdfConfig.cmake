...
if("FALSE" STREQUAL "TRUE")
  set(urdf_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-urdf-1.11.11)
  set(urdf_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-urdf-1.11.11/obj-i686-linux-gnu/devel)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@gmail.com>, Jackie Kay <jacquelinekay1@gmail.com>' to fix it.")
    endif()
    _list_append_unique(urdf_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "urdf;/usr/lib/i386-linux-gnu/liburdfdom_sensor.so;/usr/lib/i386-linux-gnu/liburdfdom_model_state.so;/usr/lib/i386-linux-gnu/liburdfdom_model.so;/usr/lib/i386-linux-gnu/liburdfdom_world.so;/usr/lib/i386-linux-gnu/libconsole_bridge.so;/usr/lib/i386-linux-gnu/libboost_thread.so;/usr/lib/i386-linux-gnu/libpthread.so")
