...
if("FALSE" STREQUAL "TRUE")
  set(kdl_parser_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-kdl-parser-1.11.11)
  set(kdl_parser_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-kdl-parser-1.11.11/obj-i686-linux-gnu/devel)
...
if(NOT "include;/usr/include/eigen3;/opt/ros/indigo/include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kdl_parser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@gmail.com>, Jackie Kay <jacquelinekay1@gmail.com>' to fix it.")
    endif()
    _list_append_unique(kdl_parser_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "kdl_parser;/opt/ros/indigo/lib/liborocos-kdl.so;/opt/ros/indigo/lib/liborocos-kdl.so.1.3.0;/usr/lib/i386-linux-gnu/libtinyxml.so")
