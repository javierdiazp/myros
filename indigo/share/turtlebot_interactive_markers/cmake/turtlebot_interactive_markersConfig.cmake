...
if("FALSE" STREQUAL "TRUE")
  set(turtlebot_interactive_markers_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-turtlebot-interactive-markers-2.3.1)
  set(turtlebot_interactive_markers_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-turtlebot-interactive-markers-2.3.1/obj-i686-linux-gnu/devel)
  ...
  set(turtlebot_interactive_markers_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_interactive_markers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Daniel Stonier <stonier@yujinrobot.com>' to fix it.")
    endif()
